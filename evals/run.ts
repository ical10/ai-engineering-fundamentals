// Custom-made evals runner.
// 1. Load the golden dataset
// 2. Run all the test cases for every objects in the dataset
// 3. Let the model work on the test cases
// 4. Get the results, score them and write it to a file
